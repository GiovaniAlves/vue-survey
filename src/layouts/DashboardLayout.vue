                  ...
                  <div class="hidden md:block">
                     <div class="ml-10 flex items-baseline space-x-4">
                        <router-link
                           ...
                           :class="[$route.name === item.name ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
                  ...
                  <div class="ml-4 flex items-center md:ml-6">
                     ...
                     <Menu as="div" class="ml-3 relative">
                        ...
                        <transition enter-active-class="transition ease-out duration-100"
                           ...
                           <MenuItems
                              class="origin-top-right justify-start absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                              <MenuItem
                                 v-slot="{ active }">
                                 <a @click="logout"
         ...
         <DisclosurePanel class="md:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
               <router-link
                  ...
                  :to="item.to"
                  active-class="bg-gray-900 text-white"
                  :class="[$route.name === item.name ? '' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
