<template>
   <div>
      ...
      <!-- Question title and actions (Add + Delete) -->
      <div class="flex items-center justify-between">
         <h3 class="text-lg font-bold pb-1">
            <!-- 1 . + Name of question -->
         ...
         <div class="flex items-center">
            ...
            <button
               ...
               class="flex items-center text-xs py-1px-3 rounded-sm border border-transparent text-red-500
         ...
         <div v-if="shouldHaveOptions()" class="mt-2">
            ...
            >
               ...
               <button
                  ...
                  class=" h-6 w-6 rounded-full flex items-center justify-center border border-transparent transition-colors
...
// change is the emit default
const emit = defineEmits(['change', 'addQuestion', 'deleteQuestion'])

// Re-create the whole question data to avoid unintentional reference change
// Use JSON.parse and JSON.stringify is necessary to lose the reference to the actual question object
...
//Check if the question should have options : Return true or false
...
function dataChange() {
   //creating the clone using JSON.parse e JSON.stringify
